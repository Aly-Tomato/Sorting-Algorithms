...
![](https://github.com/Aly-Tomato/SortingAlgorithms/blob/master/default_test.JPG "Default test results image")
...
![](https://github.com/Aly-Tomato/SortingAlgorithms/blob/master/large_test.JPG "Large test results image")
